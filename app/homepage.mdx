...
2. [Login](http://localhost:3000/login) to access your dashboard
3. [Create a new blog post](http://localhost:3000/blogs/new)
...
Source code https://github.com/Uvarov1tte/bloglist-fso-next.git